...
replace github.com/dokku/dokku/plugins/common => github.com/dokku/dokku/plugins/common v0.0.0-20210501220036-f4b4752e20dc
...
require (
	...
	github.com/dokku/dokku/plugins/config v0.0.0-20210501220036-f4b4752e20dc
